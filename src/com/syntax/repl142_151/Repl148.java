...
public class Repl148 {
	String item; 
	  ...
	  public Repl148(String item, double price, double quantity){
	    this.item = item; 
	    this.price = price; 
...
class itemTotalPricee {
	public static void main(String[] args) {
		Repl148 blancket = new Repl148("Blanket" , 49.99, 2);
		Repl148 mattress = new Repl148("Mattress" , 219.59, 2);
